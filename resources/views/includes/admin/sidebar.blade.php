    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <i class="nav-icon fa fa-tags" aria-hidden="true"></i> Brands</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <i class="nav-icon fa fa-cogs fa-3" aria-hidden="true"></i> Settings</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('users') }}">
                <i class="nav-icon fa fa-users" aria-hidden="true"></i> Users</a>
            </li>
        </ul>
    </nav>

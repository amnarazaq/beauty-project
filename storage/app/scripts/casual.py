...
def casual(conn, y_pred, colour):
            ...
            data = {
                ...
                'e_shadow' : {
                    ...
                    'category_color_type_id': 26,
                     'color_code_hex': '8a3442'
                },
                'lipstick' : {
                    'category_id':23,
                    'category_color_type_id': 27,
                     'color_code_hex': '680000'
                },
                'blush': {
                    'category_id':6,
                    'category_color_type_id': 15,
            ...
            data = {
                ...
                'eyeliner' : {
                 ...
                 'e_shadow' : {
                     'category_id':22,
                    'category_color_type_id': 28,
                     'color_code_hex': 'e3745d'
                },
                'lipstick' : {
                    'category_id':23,
                    'category_color_type_id': 19,
                     'color_code_hex': 'CF395D'                     #'AD2D25'
                },
                'blush': {
                    'category_id':6,
                    'category_color_type_id': 15,
    ...
    if c == '[2]':
       if colour== "#FF0000" or colour == "#FFA07A" or colour == "#FA8072"  or colour=="#E9967A" or  colour=="#F08080" or colour=="#CD5C5C" or colour == "#DC143C" or colour == "#B22222"  or colour=="#FF0000" or  colour=="#8B0000"or colour=="#800000"  or colour=="#DB7093"  :#red shades
            ...
            print("bridal makeup for fair_redspot skin ON saddle brown colors!!")
            data = {
                'foundation' : {
                    'category_id' : 3,
                    'category_color_type_id': 1
